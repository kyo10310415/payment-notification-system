...
| 項目 | 値 | 説明 |
|------|-----|------|
| **Schedule** | `0 10,22 * * *` | 毎日 AM10時とPM10時に実行 |
...
**実行タイミング:**
- **AM 10:00** (日本時間 19:00) - 過去12時間のメッセージを監視
- **PM 10:00** (日本時間 翌7:00) - 過去12時間のメッセージを監視

**注意:** Renderのタイムゾーンは **UTC** です。日本時間（JST）で実行したい場合は以下のように調整してください：

| 日本時間 | UTC時間 | Cron式 |
|---------|---------|-------|
| 毎日 AM 10:00 | 毎日 01:00 | `0 1 * * *` |
| 毎日 PM 10:00 | 毎日 13:00 | `0 13 * * *` |
| 毎日 AM 10:00 & PM 10:00 | 毎日 01:00 & 13:00 | `0 1,13 * * *` |
